...
namespace Hesapix.Services.Interfaces
{
    public interface ISaleService
    {
        ...
        Task<List<SaleDto>> GetSales(int userId, int page = 1, int pageSize = 20, DateTime? startDate = null, DateTime? endDate = null);
        ...
        Task<List<SaleDto>> GetPendingPaymentSales(int userId, int page =1, int pageSize = 20);
